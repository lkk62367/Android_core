...
public class MainActivity extends RosActivity implements Button.OnClickListener {
    private Button SLAMmode, Navmode, Cancel, reboot, shutdown, toolmode, teston, testoff;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolmode = (Button) findViewById(R.id.toolmode);
        toolmode.setOnClickListener(this);
    }
...
//        nodeMainExecutor.execute(listener, nodeConfiguration);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.Reboot) {
            ...
            dialog(diamsg, msg, toasts);
        } else if (v.getId() == R.id.toolmode) {
            Intent intent = new Intent();
            intent.setClass(MainActivity.this, ToolAvtivity.class);
            startActivity(intent);
            Toast.makeText(this, "ToolMode", Toast.LENGTH_SHORT).show();
        }
